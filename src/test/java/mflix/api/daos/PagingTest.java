...
public class PagingTest extends TicketTest {
    ...
    public void testPagingByGenre() {
        ...
        Assert.assertEquals(
            "Expected `title` field does match: Please check your "
                + "getMoviesByGenre() movies sort order.",
            "Only the Dead",
            movieDocs.get(0).getString("title"));
    ...
    public void testPagingByText() {
        ...
        Assert.assertEquals("Check the query used in getMoviesByText() in MoviesDao.java", 20,
            count);
    ...
    public void testPagingByTextAndSkip() {
        ...
        Assert.assertEquals(
            "Check the query used in getMovies() in MoviesDao.java", expectedCount % 20,
            finalCount);
    }
}
